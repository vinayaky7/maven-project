...
### Please make sure to use the same Hostname in Ansible Playbook as mentioned in the my_script.txt file.

### Please use correct command in the my_script.txt file to mount EFS volume.
