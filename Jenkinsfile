pipeline {
    ...
    environment {
        def image_name="radical-june-java-2023"
        def docker_tag="radical-june-java-2023-dev-1.0"
            ...
            steps {
                script {
                    try {
                        ...
                        sh 'sudo docker run -itd --name webserver300${BUILD_NUMBER} -p 300${BUILD_NUMBER}:8080 ${image_name}:${docker_tag} &'
